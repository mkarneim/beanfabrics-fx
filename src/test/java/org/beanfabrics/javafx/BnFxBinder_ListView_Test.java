...
public class BnFxBinder_ListView_Test extends ApplicationTest {

  RowPM[] row;
  MapPM<Integer, RowPM> mapPm = new MapPM<>();
  ModelProvider modelProvider = new ModelProvider();
  Path path = new Path("this");
  Path cellPath = new Path("this.title");
  ListView<RowPM> control;
  ...
  public void before() {
    ...
    control.setCellFactory(BnFxBinder.createListViewCellFactory(cellPath));
  }
